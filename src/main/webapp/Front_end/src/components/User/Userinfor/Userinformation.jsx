    ...
    return (
        <div className='MainContainEr'>
            <div className='UserBasicInfor'>
                <ul class="list-group">
                    <li class="list-group-item" id='inforItem'><span className='title_infor_item'>Mã số giáo viên: </span> {props.maGV}</li>
                    ...
                    <li class="list-group-item" id='inforItem'><span className='title_infor_item'>Khoa: </span>{props.tenKhoa}</li>
                </ul>
            </div>
        </div>
    )
